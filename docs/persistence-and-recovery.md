...
The [apply-best workflow](apply-best.md) separately persists its pre-activation snapshot and exact rollback command. The [reproducibility guide](reproducibility.md) explains artifact/backup limits and source hashing.
