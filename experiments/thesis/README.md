...
[`provenance`](provenance) holds terminal closeout, release, audit, and DOCX archive receipts. [`archive/docx`](archive/docx) retains successive research exports; the latest snapshot reflects D065 and is not a replacement for the later Markdown log. Raw evidence and database state remain in the configured artifact root and control database.
