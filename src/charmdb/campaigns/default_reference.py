...
DEFAULT_REFERENCE_MANIFEST = Path("experiments/thesis/manifests/new-machine-default-reference.json")
SATURATION_MANIFEST = Path("experiments/thesis/manifests/sanity-and-saturation.json")
