...
from charmdb.campaigns.saturation_phase2 import PHASE2_MANIFEST, phase2_manifest_payload
...
PILOT_MANIFEST = Path("experiments/thesis/manifests/warmup-and-f3-duration-pilot.json")
