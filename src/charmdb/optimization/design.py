...
from charmdb.protocol import FINAL_SCREENING_PARAMETERS, PRIMARY_SEARCH_METHODS, load_manifest

PRIMARY_MANIFEST = Path("experiments/thesis/manifests/primary-comparison.json")
PRIMARY_WAVE_B_MANIFEST = Path("experiments/thesis/manifests/primary-wave-b.json")
