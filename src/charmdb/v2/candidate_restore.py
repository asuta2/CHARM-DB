...
from charmdb.v2.protocol import EVIDENCE_ROLES, PROTOCOL_ID
...
def _ensure_candidate_dataset_restored_locked(
    ...
    *,
    ...
    if physical_archive_id is not None:
        from charmdb.v2.physical_archive import load_physical_archive
    ...
    try:
        try:
            ...
            if restore_mechanism != "physical-archive":
                raise
            from charmdb.v2.physical_archive import stopped_target_fingerprint
        ...
        if restore_mechanism == "logical-restore":
            ...
            from charmdb.v2.physical_archive import restore_physical_archive
