...
from charmdb.v2.candidate_restore import capture_live_fingerprint, compare_fingerprints
...
from charmdb.v2.primary_design import PRIMARY_MANIFEST, primary_method_design
...
MULTIFIDELITY_MANIFEST = Path("v2/config/multi-fidelity.json")
